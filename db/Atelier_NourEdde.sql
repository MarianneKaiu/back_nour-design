...
--
-- Hôte : localhost
-- Généré le : mer. 26 avr. 2023 à 14:11
...
INSERT INTO `comments` (`id`, `userName`, `content`, `createdAt`, `updatedAt`, `userId`) VALUES
...
(9, 'MarianneSans500', 'Un seul mot TOP :\nLes meubles sont beaux, colorés et réalisés avec soin.. Un grand merci pour mon hamac en soie d\'araignée ...    ', '2023-04-26 07:58:08', '2023-04-26 07:58:08', NULL),
(10, 'Test2Marianne Sans 500', 'Un seul mot TOP :\nLes meubles sont beaux, colorés et réalisés avec soin.. Un grand merci pour mon hamac en soie d\'araignée, je m\'y endors comme un bébé', '2023-04-26 08:02:14', '2023-04-26 08:02:14', NULL),
(11, 'Que la force soit avec toi', 'Tu as fait de ton mieux et ça, c\'est le mieux que tu pouvais faire                                                                ', '2023-04-26 08:11:28', '2023-04-26 08:11:28', NULL),
(12, 'Again and again', 'Les meubles de l\'atelier de Nour sont extraordinaires tant par leurs robustesse que par leurs originalité, merci pour ce travail de qualité', '2023-04-26 08:12:42', '2023-04-26 08:12:42', NULL),
(13, 'Enfin rangé dans le bon ordre ?', 'Il se pourrais bien que oui.                                                                                                      ', '2023-04-26 08:21:31', '2023-04-26 08:21:31', NULL),
(14, 'Stephanie', 'Un seul mot TOP :\nLes meubles sont beaux, colorés et réalisés avec soin.. Un grand merci pour mon hamac en soie d\'araignée, je m\'y endors comme un bébé', '2023-04-26 09:30:36', '2023-04-26 09:30:36', NULL),
(15, 'Jane', 'Un seul mot TOP :\nLes meubles sont beaux, colorés et réalisés avec soin.. Un grand merci pour mon hamac en soie d\'araignée, je m\'y endors comme un bébé', '2023-04-26 11:46:34', '2023-04-26 11:46:34', NULL),
(16, 'Jane Doe', 'Un seul mot TOP : Les meubles sont beaux, colorés et réalisés avec soin.. Un grand merci pour mon hamac en soie d\'araignée, je m\'y endors comme un bébé', '2023-04-26 12:01:07', '2023-04-26 12:01:07', NULL);
...
INSERT INTO `images` (`id`, `name`, `chemin`, `description`, `createdAt`, `updatedAt`, `categorieId`) VALUES
...
INSERT INTO `users` (`id`, `userName`, `eMail`, `password`, `createdAt`, `updatedAt`, `roleId`) VALUES
...
(9, 'Mariannh', 'Lapierreougmail.com', '$2b$10$HjfxlGD5cpXMzVtKo2EKNOfzOH3XXoDR7bhzwMdANOsEpCiTVvYUi', '2023-04-26 07:47:37', '2023-04-26 07:47:37', NULL),
(10, 'JaneDoe', 'Jane@doe.fr', '$2b$10$5QpY8wwwKbKsy1csitsfgOXq6VaxEZAUzwu4RnZG4.yPfOl9tbBbS', '2023-04-26 11:45:57', '2023-04-26 11:45:57', NULL);
...
--
ALTER TABLE `images`
  ADD CONSTRAINT `images_ibfk_1` FOREIGN KEY (`categorieId`) REFERENCES `categories` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
